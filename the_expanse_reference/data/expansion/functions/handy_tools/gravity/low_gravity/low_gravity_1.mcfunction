execute if score @s exp_jump matches 1.. unless entity @s[predicate=expansion:nbt_checks/armor/magnetic_boots] run effect give @s minecraft:levitation 1 1 true
