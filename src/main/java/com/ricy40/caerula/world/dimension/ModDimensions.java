...
public class ModDimensions {
    ...
    public static final ResourceKey<DimensionType> CAERULA_TYPE =
            ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation(Caerula.MOD_ID, "caerula"));
