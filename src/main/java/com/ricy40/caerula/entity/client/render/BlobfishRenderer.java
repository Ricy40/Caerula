...
public class BlobfishRenderer extends MobRenderer<BlobfishEntity, BlobfishModel<BlobfishEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(BlobfishEntity pEntity) {
        return TEXTURE;
    }
}
